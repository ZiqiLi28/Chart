                ...
                Surface(
                    ...
                    MainScreen(onChartSelected = { chartType ->
                        val intent = when (chartType) {
                            ...
                            "Bar Chart", "Line Chart" -> Intent(this, CreateBarLineChartActivity::class.java).apply {
...
fun MainScreen(onChartSelected: (String) -> Unit) {
    Column(
        ...
        ChartButton(text = "Bar Chart", onClick = { onChartSelected("Bar Chart") })
        // Button for selecting line chart
        ChartButton(text = "Line Chart", onClick = { onChartSelected("Line Chart") })
